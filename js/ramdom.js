...
function loadAnalysesInfo(flag) {
	...
	$(flag.analyses).each(
			function(i, obj) {
				...
				$('#analysisBoxId3 .innerbox').append(
					"<div class='analysisUnit'>" + obj.text + "</div>")
			});
	$('#rightBoxId .innerbox').html("");
	$('#rightBoxId2 .innerbox').html("");
	$(flag.answers).each(
			function(i, obj) {
				$('#rightBoxId').show();
				...
				$("#rightBoxId2").show();
				$('#rightBoxId2 .innerbox').append(	"<div class='answerUnit'>" + obj.answer.answer + weight+ "</div>");
				$('#rightBoxId .innerbox').append("<div class='answerUnit'>" + obj.answer.answer + weight	+ "</div>");
			});
}
